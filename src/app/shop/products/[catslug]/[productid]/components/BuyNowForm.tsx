...
export function BuyNowForm({buyNowDialog}:{buyNowDialog:boolean}){
    ...
    return (
        <div className={`${buyNowDialog ? 'top-1/2 opacity-100' : 'top-[70%] opacity-0 pointer-events-none'} transition-all fixed min-w-[300px] sm:w-[400px] md:w-[500px] p-5 px-3 sm:px-5 rounded-2xl z-50 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#fdfcfc] `}>
            {isSuccess 
            ?
            <div className="flex py-[20px] flex-col items-center gap-2 h-full">
            ...
            <div className="flex gap-4 flex-col">
                ...
                <div className="">
                    ...
                    <button disabled={isPending} onClick={()=>formik.submitForm()} className={` h-[45px] flex justify-center items-center w-full text-center p-3 rounded-2xl px-3 bg-customBlack hover:opacity-90 transition text-white ${isPending && 'opacity-70'} text-white`}>
                        {isPending 
                        ? 
                            <div role="status  ">
